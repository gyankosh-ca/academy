...
| **Global Rules** | `./.cursor/global/` | `Buddhi/50_System_Context/` | System protocols, workflow, philosophy |
| **AI Core** | `./.cursor/ai_core/` | `gyankosh-core` | Agent definitions, Skills, Scripts, Rules |

---

## 🚀 Operational Workflow (Mandatory)
1. **Context First:** Before performing any task, read `./.cursor/global/System_Protocol.md` and `./docs/PRD.md`.
